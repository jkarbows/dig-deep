...
var Dungeon = {
    ...
    Generate: function () {
        ...
        var room_count = Helpers.GetRandom(15, 25) + 2;
        var min_size = 5;
        var max_size = 15;
       
        var exit = {x: 63, y: 63, w: 2, h: 2};
                this.rooms.push(exit);
    ...
    FindClosestRoom: function (room) {
        ...
        for (var i = 0; i < this.rooms.length; i++) {
            ...
            var distance = Math.sqrt(Math.abs(mid.x - check_mid.x) - (room.w / 2) - (check.w / 2), Math.abs(mid.y - check_mid.y) - (room.h / 2) - (check.h / 2));
